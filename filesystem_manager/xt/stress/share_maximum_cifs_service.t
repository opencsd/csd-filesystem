...
subtest 'maximum_cifs_service_create' => sub
{
    ...
    my $share_list = $t->cluster_share_cifs_list();
    my $count      = 0;
    ...
    {
        ok(1, 'maximum_cifs_service_create_check');
    }
    else
    {
        ok(0, 'maximum_cifs_service_create_check');
    }
};

subtest 'cifs_services_delete' => sub
{
    my $t = Test::AnyStor::Share->new(addr => $GMS_TEST_ADDR);
